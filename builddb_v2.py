...
# Define the headers for the CSV files
headers_map_records = ["MapName", "MapTier", "WRTime", "WRHolder", "Completions", "AverageTime", "Bonuses"]
...
for row in table.findAll('tr'):
    ...
    if values:
        # Initialize the additional fields with None
        values += [None, None, None]  # Completions, AverageTime, Bonuses
        # Write to the SQLite database
